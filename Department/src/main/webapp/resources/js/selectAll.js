...
// -> 배열 내 요소를 하나씩 떠내서 이벤트 리스너를 추가하면 된다!!
...
for(let btn of deleteBtnList){ //향상된 for 문
    ...
    btn.addEventListener("click", e => {
        ...
        // 중에서 CSS 선택자가 일치하는 요소를 찾을 떄 까지 검색해
        ...
        if(confirm(`${deptId} 부서를 정말 삭제하시겠습니까?` )){
            ...
            //     --> 임의의 사용자가 삭제요청을 마음댜ㅐ로 보내는 문제가
            //   발생할 수 있다!!!
            // location.href = "/department/delete?deptId =" + deptId;


            //삭제 요청 보내기 2) form 태그를 만즐어서 POST 방식 요청 보내기
