...
<body>
        ...
        <%-- 주소에서 절대/상대 경로
            ...
            상대 경로 : 주소 제일 마지막 경로 부터 원하는 요청 주소 까지를 작성
                        insert
         --%>
         <%-- 상대 경로 방식으로 주소를 작성 --%>
        <form action="insert" method = "POST">
            ...
            <div>
                    부서코드 (DEPT_ID) : <input type = "text" name = "deptId">
            </div>
        
            <div>
                    부서이름 (DEPT_TITLE) : <input type = "text" name = "deptTitle">
            </div>

            <div>
                    부서이름 (LOCATION_ID) : <input type = "text" name = "locationId">
            </div>
